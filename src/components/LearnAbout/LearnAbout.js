                    ...
                    <div className="col-lg-6">
                        <div className="learn__right">
                            ...
                            <ul className="list__content">
                                <li><FontAwesomeIcon icon="check-circle"/>Mathematics</li>
                                <li><FontAwesomeIcon icon="check-circle"/>English</li>
                                <li> <FontAwesomeIcon icon="check-circle"/>Coding</li>
                                <li> <FontAwesomeIcon icon="check-circle"/>Science</li>
                            </ul>
                            <p className="learn__contnet2">
                                As a word from our heart, we love to dedicate for Kids the valuable things in
                                Life . We go with kids to play, learn, and grow better.
                            </p>
                            <Router>
                                <h5 className="have__q3">Have a question? 
                                <Link to="/" className="start__free">Get Started Free</Link></h5>
                            </Router>  
                        </div>
                    </div>
                </div>

...
export const Container = tw.div`text-center bg-blue-300 p-2 rounded w-1/2 mt-8` //Dashboard Analytics Container
export const H3 = tw.h3`font-bold text-4xl text-pink-600` //Dashboard Title

export const AnalyticsContainer = tw.div`border-solid border-green-500 rounded content-center` // Analytics Border Window

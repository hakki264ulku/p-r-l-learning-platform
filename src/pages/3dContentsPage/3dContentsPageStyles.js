...
export const Container = tw.div`text-center h-screen bg-yellow-200 pt-2`; //3D Content Page Container bg-indigo-200
...
export const ContentsContainer = tw.div`flex m-1 justify-between flex-wrap border-solid border-yellow-500 rounded mt-8 ml-2 w-2/3 p-2`;
